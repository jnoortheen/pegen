...
from xsh_parser.tokenize import (
    tokenize,
    _tokenize,
    untokenize,
    NUMBER,
...
class TestTokenize(TestCase):
    def test_tokenize(self):
        ...
        try:
            ...
            self.assertEqual(
                list(results), [b"first", b"second", b"1", b"2", b"3", b"4"]
            )
        finally:
    ...
    def test_comment_at_the_end_of_the_source_without_newline(self):
        ...
        for i in range(6):
            self.assertEqual(
                tok_name[tokens[i + 1].exact_type], tok_name[expected_tokens[i]]
            )
